...
// configuration step. It creates a namespace called `DewJunkieTest`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", DewJunkieTest::cmake::project_name, DewJunkieTest::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", DewJunkieTest::cmake::project_version);
      return EXIT_SUCCESS;
    }
